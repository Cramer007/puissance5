...
int main() {
    ...
    std::cout << "Entrez le nombre de lignes du plateau : ";
    std::cin >> lignes;

    std::cout << "Entrez le nombre de colonnes du plateau : ";
    std::cin >> colonnes;
    ...
    Jeu jeu(lignes, colonnes, joueurs); // un plateau de dimensions personnalisées
    jeu.jouer();
    return 0;
}
